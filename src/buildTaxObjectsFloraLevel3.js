...
module.exports = function (aeDb, taxFlora, taxObjectsFloraLevel1, taxObjectsFloraLevel2, objects) {
  return new Promise((resolve, reject) => {
    aeDb.view('artendb/baumFlora', {
      group_level: 4
    }, (error, result) => {
      ...
      aeDb.save(taxObjectsFloraLevel3, (error, results) => {
