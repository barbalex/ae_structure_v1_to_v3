...
module.exports = function (db, taxMoose, taxObjectsMooseLevel1, taxObjectsMooseLevel2, taxObjectsMooseLevel3, objects) {
  return new Promise((resolve, reject) => {
    db.view('artendb/prov_baumMoose', {
      ...
      db.save(taxObjectsMooseLevel4, (error, results) => {
